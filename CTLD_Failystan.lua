...
ctld.troopPickupAtFOB = false -- if true, troops can also be picked up at a created FOB
...
ctld.JTAC_LIMIT_BLUE = 2 -- max number of JTAC Crates for the BLUE Side
...
function ctld.generateLaserCode()
    ...
    ctld.jtacGeneratedLaserCodes = { 1688 }
...
env.info("CTLD FAILYSTAN IS READY!")
